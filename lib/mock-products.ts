...
export const mockProducts: Product[] = [
  {
    ...
    name: "Aceite de CBD Nano Moringa",
    slug: "aceite-cbd-nano-moringa",
    description: "Aceite de CBD micronizado para mejor absorción diaria. Producto medicinal 100% natural.",
    longDescription: "Nuestro aceite de CBD Nano Moringa está micronizado para una mejor absorción diaria.\n\n✔️ Micronizado para mejor absorción\n✔️ Producto 100% natural\n✔️ Apoyo antioxidante\n✔️ Ayuda a mantener el enfoque sin picos ni caídas\n✔️ Ideal para tu rutina diaria\n✔️ Bienestar en cada gota\n\nUso recomendado: Aplicación tópica en la zona de molestia. Masajear suavemente hasta absorción completa. Para uso diario, integrar en tu rutina AM/PM.",
    long_description: "Aceite de CBD micronizado para bienestar diario. Producto medicinal 100% natural.",
    price: 50000,
    compareAt: 75000,
    compare_at: 75000,
    category: "Aceites",
  ...
  },
  {
    ...
    name: "Aceite de CBD Nano Moringa 60ml",
    slug: "aceite-cbd-nano-moringa-60ml",
    description: "Presentación grande de aceite de CBD micronizado. Ideal para uso continuo.",
    longDescription: "Nuestra presentación de 60ml de aceite de CBD micronizado es ideal para uso continuo y rutinas diarias.\n\n✔️ Mayor cantidad, mejor precio\n✔️ Micronizado para mejor absorción\n✔️ Producto 100% natural\n✔️ Ideal para rutinas AM/PM\n✔️ Constancia que se nota\n\nPerfecto para quienes buscan mantener su bienestar diario de forma constante.\n\nUso: Aplicación tópica diaria. Integrar en tu rutina de autocuidado.",
    long_description: "Presentación grande de aceite de CBD micronizado para uso continuo.",
    price: 85000,
    category: "Aceites",
    sizes: ["60ml"],
    colors: ["Natural"],
