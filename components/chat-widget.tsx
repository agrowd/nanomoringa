...
export function ChatWidget() {
  ...
  // Exponer el estado para que la notificación pueda verificar si está cerrado
  useEffect(() => {
  ...
  return (
    <>
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-20 right-4 sm:right-6 z-50 w-[calc(100vw-2rem)] sm:w-96 h-[600px] max-h-[85vh] animate-in slide-in-from-bottom-5 duration-300">
      ...
      <button
        onClick={toggleChat}
        className="fixed bottom-6 right-6 z-40 w-16 h-16 rounded-full bg-gradient-to-br from-[#25D366] to-[#20BA5A] hover:from-[#20BA5A] hover:to-[#1DA851] text-white shadow-2xl hover:shadow-green-500/50 transition-all duration-300 hover:scale-110 flex items-center justify-center group"
